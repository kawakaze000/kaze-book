<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="关注者id" prop="followId">
        <el-input
          v-model="queryParams.followId"
          placeholder="请输入关注者id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="粉丝id" prop="fanId">
        <el-input
          v-model="queryParams.fanId"
          placeholder="请输入粉丝id"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="followList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关注者id" align="center" prop="followId" />
      <el-table-column label="粉丝id" align="center" prop="fanId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="关注者id" prop="followId">
          <el-input v-model="form.followId" placeholder="请输入关注者id" />
        </el-form-item>
        <el-form-item label="粉丝id" prop="fanId">
          <el-input v-model="form.fanId" placeholder="请输入粉丝id" />
        </el-form-item>
        <el-form-item label="用户名" prop="userName">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        fanId: [
          { required: true, message: "粉丝id不能为空", trigger: "blur" }
        ],
        userName: [
